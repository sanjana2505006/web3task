    ...
    return (
        <div className="w-full h-full relative group">
            ...
            <YouTube
                ...
                className="w-full h-[60vh] rounded-2xl overflow-hidden glass-panel"
                iframeClassName="w-full h-full"
            />

            {!hasPermission && (
                <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full text-xs font-semibold text-gray-300 z-20">
